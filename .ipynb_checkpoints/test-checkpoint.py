...
#If prediction > 0.5, it is set to 1, otherwise to 0
prediction = (output_test_all >= 0.5).int()
accuracy = sum((prediction==test_target).int())/1000

print("Accuracy:  ", accuracy.item())
#Plot
plot(test_input, prediction, nb_epochs, nb_train_errors, nb_test_errors)
